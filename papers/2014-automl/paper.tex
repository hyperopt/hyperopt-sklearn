...
\begin{figure}
    \centering
    \includegraphics[width=4.5in]{graphics/scores_by_classifier}
    %\includegraphics[width=2.9in]{graphics/scores_per_eval}
    \caption{
	    Using Hyperopt's Anneal search algorithm, increasing the number of function evaluations from 150 to 2400 lead to a modest improvement in accuracy on 20 Newsgroups and MNIST,
...
\begin{figure}
    ...
    \caption{
        Hyperopt's TPE algorithm makes gradual progress on 20 Newsgroups over 300 iterations and gives no indication of convergence.
        We look forward to investigating alternative optimization algorithms in future work.
    }
    \label{fig:errtpe}
\end{figure}
