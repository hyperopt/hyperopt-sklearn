...
\begin{abstract}
    Hyperopt-sklearn\footnote{Hyperopt-Sklearn home: http://github.com/hyperopt/hyperopt-sklearn} is a new software project that provides automatic algorithm configuration of the Scikit-learn machine learning library.
