...
\begin{table}
    ...
    \begin{tabular}{llllll}
        ...
        \hline
        Committee of convnets & 99.8\%                & thing & 85\%  & \textbf{hyperopt-sklearn} & 88.9\%\\
        \textbf{hyperopt-sklearn} & \textbf{98.7}\%   & thing & 85\%  & hp-dbnet & 84.6\% \\
        libSVM grid search & 98.6\%                   & thing & 85\% & dbn-3 & 81.4\%\\
        Boosted trees & 98.5\%                        & thing & 85\%  &  &  \\
    \end{tabular}
\end{table}
