...
@validate(params=["loss"],
          validation_test=lambda param: isinstance(param, str) and param in ["absolute_error", "squared_error"],
...
def ransac_regression(name: str,
                      ...
                      max_trials: int = None,
                      max_skips: int = None,
                      stop_n_inliers: int = None,
                      stop_score: float = None,
                      stop_probability: float = None,
                      loss: typing.Union[callable, str] = None,
                      random_state=None):
    """
    ...
    hp_space = dict(
        ...
        max_trials=max_trials or hp.uniform(_name("max_trials"), 50, 150),
        ...
        stop_probability=stop_probability or hp.uniform(_name("stop_probability"), 0.90, 0.99),
        loss=loss or hp.choice(_name("loss"), ["absolute_error", "squared_error"]),
